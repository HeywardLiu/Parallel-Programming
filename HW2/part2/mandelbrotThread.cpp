...
void workerThreadStart(WorkerArgs *const args)
{
    ...
    /* Spatial Decomposition, Coarse-grain style */
    // int workload = args->height / args->numThreads;  
    // int start_row_t = args->threadId * workload;     // start row of each threads
    // mandelbrotSerial(args->x0, args->y0, args->x1, args->y1, args->width, args->height, start_row_t, workload, args->maxIterations, args->output);

    /* Cyclic Decomposition, Fine-grain style */
